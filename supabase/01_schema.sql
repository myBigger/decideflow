-- ============================================================
-- DecideFlow — Supabase Database Schema (Initial Setup)
--
-- Usage: Run this file ONCE when creating a new Supabase project.
--         It assumes a completely empty database.
--
...
-- Marks expired 'voting' decisions as 'rejected'.
-- Note: Vote result calculation (passed/rejected) must be done
-- by the vote route when the threshold is met.
